...
for file in "${XML_INPUT[@]}"; do   f=$(basename "$file" .xml);   echo "Processing file '$file'.";    java -jar $CGVIEW_JAR -i "$file" -f png -o ./test_maps/"${f}".png;   java -jar $CGVIEW_JAR -i "$file" -f svg -o ./test_maps/"${f}".svg; done
...
for file in "${TAB_INPUT[@]}"; do   f=$(basename "$file" .tab);   echo "Processing file '$file'.";    java -jar $CGVIEW_JAR -i "$file" -f png -o ./test_maps/"${f}".png;   java -jar $CGVIEW_JAR -i "$file" -f svg -o ./test_maps/"${f}".svg; done
echo "Maps created in 'test_maps'."
